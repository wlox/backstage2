...
(function() {
  ...
  */
  ...
  CKEDITOR.plugins.add("gg", {
    init: function(b) {
      b.addCommand("simpleLinkDialog", new CKEDITOR.dialogCommand("simpleLinkDialog"));
      b.ui.addButton("gg", {
        label: "Insert a ZS Google map",
        command: "simpleLinkDialog",
        icon: this.path + "images/gg.png"
      });
      CKEDITOR.dialog.add("simpleLinkDialog", function(b) {
        return {
          ...
          onOk: function() {
            ...
            b.insertHtml('<img src="http://maps.googleapis.com/maps/api/staticmap?zoom=' + a.zoom + "&size=" + a.hor + "x" + a.ver + "&maptype=" + c + "&markers=color:red%7Ccolor:red%7Clabel:C%7C" + a.lat + "," + a.lon + '&sensor=false"/>')
          }
        }
      })
    }
