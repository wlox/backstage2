...
class Settings
{
    ...
    public static function set($name, $value)
    {
        ...
        $affected_rows = db_update('settings', $name, array('value' => mysqli_real_escape_string(htmlentities($value)) ), 'name');

        if (! $affected_rows) {
            db_insert('settings', array('name' => $name, 'value' => mysqli_real_escape_string(htmlentities($value)) ), '', true);
        }
