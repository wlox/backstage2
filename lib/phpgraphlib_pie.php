...
class PHPGraphLibPie extends PHPGraphLib
{
    ...
    public $pie_precision=0; //NUMBER OF SIGNIFICANT DIGITS IN LABEL %
    public $bool_legend=true;
    public $bool_data_labels=true;
    public $pie_3D_height_percent=4; //IS % OF TOTAL WIDTH
    public $pie_legend_text_width=6; //IN PX...
    public $pie_legend_text_height=12;
    public $pie_label_text_width=6;
    public $pie_label_text_height=12;
    public $pie_legend_padding=5; //PADDING INSIDE LEGEND BOX
    //DEFAULT COLORS, IN ORDER OF DISPLAY ON GRAPH - YOU CAN CHANGE ORDER IF NEEDED
    public $pie_avail_colors=array('pastel_orange_1','pastel_orange_2','pastel_blue_1','pastel_green_1','clay',
    ...
    public $pie_center_y_offset=50; //in %
    public $pie_center_x_offset=50; //in %
    public $pie_center_legend_scale=55; //OFFSET IN % OF EXISTING COORDS WHEN LEGEND
    public $pie_width_percent=75; //DEFAULT WIDTH % OF TOTAL WIDTH
    public $pie_height_percent=28;
    public $pie_label_scale=90; //IN % SCALE WIDTH/HEIGHT IF DATA LABELS
    public $pie_legend_scale=64;//IN % SCALE WIDTH/HEIGHT IF LEGEND
    //INTERNALS - DO NOT CHANGE
    public $pie_width;
    public $pie_height;
    public $pie_center_x;
    public $pie_center_y;
    public $pie_legend_width;
    public $pie_legend_height;
    public $pie_legend_x;
    public $pie_legend_y;
    public $pie_data_max_length=0;
    public $pie_color_pointer=0;
    public $pie_data_array_percents;
    public $pie_data_label_space;
    public $pie_3D_height;
    public function PHPGraphLibPie($width='', $height='')
    {
    ...
    public function generateDataLabel($value, $arcStart)
    {
    ...
    public function dataLabelHandicap($x, $y, $value, $midway)
    {
    ...
    public function generateNextColor($dark=false)
    {
    ...
    public function resetColorPointer()
    {
        $this->pie_color_pointer=0;
    }
    ...
    public function setupXAxis()
    {
    }
    public function setupYAxis()
    {
    }
